...
export const Heading = ({ level, children, id, className, registerSidebarAnchor, }) => {
    ...
    return (_jsxs(Component, { className: heading({ className, level }), ref: registerSidebarAnchor ? ref : undefined, id: id, children: [id && (_jsx("a", { href: `#${id}`, className: "no-underline absolute text-primary -left-[0.8em] pr-2.5 opacity-0 group-hover:opacity-50 hover:!opacity-100 transition-opacity duration-200", "aria-label": `Link to ${id}`, children: "#" })), children] }));
};
