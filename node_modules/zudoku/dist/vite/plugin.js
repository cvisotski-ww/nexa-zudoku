...
export default function vitePlugin(initialConfig, onConfigChange) {
    const [configReloadPlugin, getCurrentConfig] = createConfigReloadPlugin(initialConfig, onConfigChange);
    return [
