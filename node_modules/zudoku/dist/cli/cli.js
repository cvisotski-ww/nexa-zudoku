...
if (gte(process.versions.node, MIN_NODE_VERSION)) {
    ...
    try {
        ...
        logger.error(e);
        await printCriticalFailureToConsoleAndExit(`Unable to load zudoku cli. The package.json is missing or malformed.`);
    }
    if (SENTRY_DSN) {
        Sentry.init({
            dsn: SENTRY_DSN,
    ...
    await printCriticalFailureToConsoleAndExit(`The Zudoku CLI requires at least node.js v${MIN_NODE_VERSION}. You are using v${process.versions.node}. Please update your version of node.js.
