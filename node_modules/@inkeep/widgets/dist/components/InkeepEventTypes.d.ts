...
import { MessageArray, MessageTypename } from './AIChat/AIChatPage/AIChatPage';
...
export interface AIChatThumbsUpFeedbackSubmittedEvent {
    ...
    properties: {
        chatSessionAllMessages: MessageArray;
...
export interface SearchResultClickedEvent {
    ...
    properties: {
        ...
        clickedHitPosition: number;
        clickedHitId: string;
        clickedHitRootRecordId: string;
        clickedHitType: string;
