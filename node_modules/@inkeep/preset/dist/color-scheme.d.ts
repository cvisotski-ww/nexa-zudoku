...
declare const getColorSchemeVars: (colorDict?: UserProvidedColorScheme, prefix?: string) => Record<"--colors-medium" | "--colors-light" | "--colors-lighter" | "--colors-hitContentPreview" | "--colors-textBold" | "--colors-textSubtle" | "--colors-lightSubtle" | "--colors-strong" | "--colors-stronger" | "--colors-hitContentPreviewHover" | "--colors-textColorOnPrimary", string>;
