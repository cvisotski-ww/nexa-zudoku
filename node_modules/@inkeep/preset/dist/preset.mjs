...
var switchRecipe = defineSlotRecipe4({
  className: chakraRecipes6.switchRecipe.className,
...
var switchToChatButtonRecipe = defineSlotRecipe5({
...
var tabsRecipe = defineSlotRecipe6({
  className: chakraRecipes7.tabs.className,
  slots: chakraRecipes7.tabs.slots,
  base: {
    indicator: {
...
var tooltipRecipe = defineSlotRecipe7({
  className: chakraRecipes8.tooltip.className,
  slots: chakraRecipes8.tooltip.slots,
  base: {
    content: {
      py: 2,
      px: 3,
