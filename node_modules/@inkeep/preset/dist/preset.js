...
var switchRecipe = (0, import_dev11.defineSlotRecipe)({
  className: import_preset_chakra6.chakraRecipes.switchRecipe.className,
...
// src/recipes/switch-to-chat-button.recipe.ts
var import_dev12 = require("@pandacss/dev");
var switchToChatButtonRecipe = (0, import_dev12.defineSlotRecipe)({
  className: "switch-to-chat-button",
  jsx: ["SwitchToChat", /SwitchToChatButtonSlots\.+/],
  slots: ["wrapper", "container", "icon", "text"],
  base: {
    container: {
      cursor: "pointer",
      display: "inline-flex",
  ...
  variants: {
    variant: {
      subtle: {
        container: {
          ...
          _hover: {
            ...
            color: "inkeepExpandedPrimary.800"
          },
          _dark: {
            color: "inkeepExpandedPrimary.300",
            _hover: {
      ...
      primary: {
        container: {
          bg: "inkeepPrimary.lightSubtle",
          color: "inkeepExpandedPrimary.700",
          _hover: {
            bg: "inkeepExpandedPrimary.50",
            color: "inkeepExpandedPrimary.800"
          },
          _dark: {
            bg: "whiteAlpha.200",
...
var tabsRecipe = (0, import_dev13.defineSlotRecipe)({
  className: import_preset_chakra7.chakraRecipes.tabs.className,
  slots: import_preset_chakra7.chakraRecipes.tabs.slots,
  base: {
    indicator: {
...
var tooltipRecipe = (0, import_dev14.defineSlotRecipe)({
  className: import_preset_chakra8.chakraRecipes.tooltip.className,
  slots: import_preset_chakra8.chakraRecipes.tooltip.slots,
  base: {
    content: {
      py: 2,
      px: 3,
...
var inkeepRecipes = {
  ...
  switchRecipe,
  switchToChatButton: switchToChatButtonRecipe,
  tabs: tabsRecipe,
