...
import { cssVar } from "@inkeep/shared";
import { colorMixVar } from "@inkeep/shared";
var vars = cssVar.scope("alert", ["fg", "bg", "bg-alpha"]);
var bgDark = colorMixVar("colorPalette.200/16", vars["bg-alpha"]);
...
import { cssVar as cssVar2 } from "@inkeep/shared";
var vars2 = cssVar2.scope("avatar", [
  "border-color",
...
var avatarRecipe = defineSlotRecipe2({
  className: "avatar",
...
import { colorMixVar as colorMixVar2, cssVar as cssVar3 } from "@inkeep/shared";
var vars3 = cssVar3.scope("badge", [
  ["bg", "inherit"],
  ["bg-alpha", "inherit"],
  ["color", "inherit"],
  "shadow"
...
var bgDark2 = {
  solid: colorMixVar2("colorPalette.500/40", vars3["bg-alpha"]),
  subtle: colorMixVar2("colorPalette.200/16", vars3["bg-alpha"]),
  outline: colorMixVar2("colorPalette.200/20", vars3["bg-alpha"])
};
...
import { defineRecipe as defineRecipe2, defineStyles } from "@pandacss/dev";
var variantGhostStyles = defineStyles({
...
import { cssVar as cssVar4 } from "@inkeep/shared";
import { defineSlotRecipe as defineSlotRecipe3 } from "@pandacss/dev";
var vars4 = cssVar4.scope("card", [
  "bg",
  "padding",
  "shadow",
  "radius",
...
var cardRecipe = defineSlotRecipe3({
  className: "card",
...
import { cssVar as cssVar5 } from "@inkeep/shared";
import { defineSlotRecipe as defineSlotRecipe4 } from "@pandacss/dev";
var $size = cssVar5.create("checkbox-size", "1em");
var checkboxRecipe = defineSlotRecipe4({
  className: "checkbox",
...
import { cssVar as cssVar6 } from "@inkeep/shared";
var $size2 = cssVar6.create("btn-bg");
var $bg = cssVar6.create("btn-size");
var closeButtonRecipe = defineRecipe3({
  className: "close-btn",
  base: {
    w: $size2.ref,
    h: $size2.ref,
...
import { cssVar as cssVar7 } from "@inkeep/shared";
import { defineSlotRecipe as defineSlotRecipe5 } from "@pandacss/dev";
var vars5 = cssVar7.scope("form", ["control-color", "error-color"]);
var formControlRecipe = defineSlotRecipe5({
...
var headingRecipe = defineRecipe5({
  className: "heading",
  base: {
    fontFamily: "heading",
    fontWeight: "bold"
...
import { cssVar as cssVar8 } from "@inkeep/shared";
import { defineSlotRecipe as defineSlotRecipe6 } from "@pandacss/dev";
var vars6 = cssVar8.scope("input", [
  "focus-border-color",
  "error-border-color",
  "height",
  "font-size",
...
var inputRecipe = defineSlotRecipe6({
  className: "input",
...
import { cssVar as cssVar9 } from "@inkeep/shared";
var $bg2 = cssVar9.create("kbd-bg");
var kbdRecipe = defineRecipe7({
  className: "kbd",
  base: {
    [$bg2.name]: "gray.100",
    _dark: {
...
import { cssVar as cssVar10 } from "@inkeep/shared";
var $bg3 = cssVar10.create("modal-bg");
var $shadow = cssVar10.create("modal-shadow");
...
var modalRecipe = defineSlotRecipe7({
  className: "modal",
...
import { cssVar as cssVar11 } from "@inkeep/shared";
import { defineSlotRecipe as defineSlotRecipe8 } from "@pandacss/dev";
var vars7 = cssVar11.scope("popper", ["bg", "arrow-bg", "arrow-shadow-color"]);
var arrow = cssVar11.scope("arrow", [
  "size",
  "size-half",
  "background",
  "offset"
]);
var popoverRecipe = defineSlotRecipe8({
  className: "popover",
...
import { cssVar as cssVar12 } from "@inkeep/shared";
var vars8 = cssVar12.scope("select", ["bg"]);
var $bg4 = vars8.bg;
var selectRecipe = defineSlotRecipe9({
  className: "select",
...
import { cssVar as cssVar13 } from "@inkeep/shared";
var $speed = cssVar13.create("skeleton-speed", "0.8s");
var skeletonRecipe = defineRecipe9({
  className: "skeleton",
  base: {
...
var diffValue = calc.subtract(vars9["track-width"], vars9["track-height"]);
var switchRecipe = defineSlotRecipe10({
  className: "switch",
  ...
  base: {
    root: {
      colorPalette: "blue",
      [vars9["track-diff"].name]: diffValue,
      [vars9["thumb-x"].name]: vars9["track-diff"].ref,
      _rtl: {
        [vars9["thumb-x"].name]: calc(vars9["track-diff"]).negate().toString()
      },
      //
      position: "relative",
      verticalAlign: "middle",
    ...
    control: {
      borderRadius: "full",
      p: "0.5",
      width: vars9["track-width"].ref,
      height: vars9["track-height"].ref,
      transitionProperty: "background, transform",
      transitionDuration: "fast",
      [vars9.bg.name]: "colors.gray.300",
      _dark: {
        [vars9.bg.name]: "colors.whiteAlpha.400"
      },
      _focusVisible: {
        boxShadow: "outline"
      },
      ...
      _checked: {
        [vars9.bg.name]: `colors.colorPalette.500`,
        _dark: {
          [vars9.bg.name]: `colors.colorPalette.200`
        }
      },
      bg: vars9.bg.ref,
      //
    ...
    thumb: {
      ...
      width: vars9["track-height"].ref,
      height: vars9["track-height"].ref,
      _checked: {
        transform: `translateX(${vars9["thumb-x"].ref})`
      }
    },
    label: {
      userSelect: "none",
  ...
  variants: {
    size: {
      sm: {
        root: {
          [vars9["track-width"].name]: "1.375rem",
          [vars9["track-height"].name]: "sizes.3"
        }
      },
      md: {
        root: {
          [vars9["track-width"].name]: "1.875rem",
          [vars9["track-height"].name]: "sizes.4"
        }
      },
      lg: {
        root: {
          [vars9["track-width"].name]: "2.875rem",
          [vars9["track-height"].name]: "sizes.6"
        }
      }
    }
  },
...
import { defineSlotRecipe as defineSlotRecipe11, defineStyles as defineStyles2 } from "@pandacss/dev";
var numericStyles = defineStyles2({
  "&[data-is-numeric=true]": {
    textAlign: "end"
  }
});
var tableRecipe = defineSlotRecipe11({
  className: "table",
...
import { cssVar as cssVar15 } from "@inkeep/shared";
var vars10 = cssVar15.scope("tabs", [
  "color",
  "bg",
  "border-color",
  "border-prop",
...
var $fg = vars10.color;
var $bg5 = vars10.bg;
var $border = vars10["border-color"];
var tabsRecipe = defineSlotRecipe12({
  className: "tabs",
  ...
  base: {
    ...
    list: {
      ...
      _vertical: {
        flexDirection: "column",
        borderInlineStart: vars10["border-color"].ref,
        marginInlineStart: vars10["margin-prop"].ref
      },
      _horizontal: {
        flexDirection: "row",
        borderBottom: vars10["border-color"].ref,
        marginBottom: vars10["margin-prop"].ref
      }
    },
    trigger: {
      outline: "0",
  ...
  variants: {
    ...
    variant: {
      line: {
        list: {
          [vars10["border-color"].name]: "2px solid",
          borderColor: "inherit"
        },
        trigger: {
          [vars10["border-color"].name]: "2px solid",
          borderColor: "transparent",
          [vars10["margin-prop"].name]: "-2px",
          _selected: {
...
import { cssVar as cssVar16 } from "@inkeep/shared";
var vars11 = cssVar16.scope("tag", [
  "bg",
  "color",
  "shadow",
  "min-height",
...
var tagRecipe = defineRecipe10({
  ...
  base: {
    ...
    lineHeight: 1.2,
    outline: 0,
    [vars11.color.name]: vars3.color.ref,
    [vars11.bg.name]: vars3.bg.ref,
    [vars11.shadow.name]: vars3.shadow.ref,
    color: vars11.color.ref,
    bg: vars11.bg.ref,
    boxShadow: vars11.shadow.ref,
    borderRadius: "md",
    minH: vars11["min-height"].ref,
    minW: vars11["min-width"].ref,
    fontSize: vars11["font-size"].ref,
    px: vars11["padding-inline"].ref,
    _focusVisible: {
      [vars11.shadow.name]: "shadows.outline"
    },
    //
    display: "inline-flex",
    verticalAlign: "top",
  ...
  variants: {
    ...
    size: {
      sm: {
        [vars11["min-height"].name]: "sizes.5",
        [vars11["min-width"].name]: "sizes.5",
        [vars11["font-size"].name]: "fontSizes.xs",
        [vars11["padding-inline"].name]: "space.2"
      },
      md: {
        [vars11["min-height"].name]: "sizes.6",
        [vars11["min-width"].name]: "sizes.6",
        [vars11["font-size"].name]: "fontSizes.sm",
        [vars11["padding-inline"].name]: "space.2"
      },
      lg: {
        [vars11["min-height"].name]: "sizes.8",
        [vars11["min-width"].name]: "sizes.8",
        [vars11["font-size"].name]: "fontSizes.md",
        [vars11["padding-inline"].name]: "space.3"
      }
    }
  },
  defaultVariants: {
...
var textareaRecipe = defineRecipe11({
  className: "textarea",
  base: {
    ...inputRecipe.base?.field,
    paddingY: "2",
...
var checkboxKeyframes = defineKeyframes({
  checkAnim: {
...
import { colorMix } from "@inkeep/shared";
var noOfLines = defineUtility({
  className: "n-lines",
  values: { type: "number" },
  transform(value) {
    return {
...
var backgroundAlpha = defineUtility({
  shorthand: ["bga"],
