...
var c = (t, e2, s2, r) => (pe3(t, e2, "write to private field"), r ? r.call(t, s2) : e2.set(t, s2), s2);
...
var yt3 = (Ge = class extends xe2 {
  ...
  onUnsubscribe() {
    var e2;
    this.hasListeners() || ((e2 = i(this, A2)) == null || e2.call(this), c(this, A2, void 0));
  }
  setEventListener(e2) {
    var s2;
    c(this, J, e2), (s2 = i(this, A2)) == null || s2.call(this), c(this, A2, e2((r) => {
      typeof r == "boolean" ? this.setFocused(r) : this.onFocus();
    }));
  }
  setFocused(e2) {
    i(this, K) !== e2 && (c(this, K, e2), this.onFocus());
  }
  onFocus() {
...
var pt2 = (ze2 = class extends xe2 {
  ...
  onUnsubscribe() {
    var e2;
    this.hasListeners() || ((e2 = i(this, k)) == null || e2.call(this), c(this, k, void 0));
  }
  setEventListener(e2) {
    var s2;
    c(this, X, e2), (s2 = i(this, k)) == null || s2.call(this), c(this, k, e2(this.setOnline.bind(this)));
  }
  setOnline(e2) {
    i(this, Z2) !== e2 && (c(this, Z2, e2), this.listeners.forEach((r) => {
      r(e2);
    }));
  }
  isOnline() {
...
var gt2 = (Ve2 = class {
  ...
  scheduleGc() {
    this.clearGcTimeout(), me2(this.gcTime) && c(this, _2, setTimeout(() => {
      this.optionalRemove();
    }, this.gcTime));
  }
  updateGcTime(t) {
  ...
  clearGcTimeout() {
    i(this, _2) && (clearTimeout(i(this, _2)), c(this, _2, void 0));
  }
...
var Jt2 = ($e2 = class extends gt2 {
  constructor(e2) {
    ...
    y(this, ae2);
    y(this, H2);
    c(this, H2, false), c(this, ae2, e2.defaultOptions), this.setOptions(e2.options), this.observers = [], c(this, D2, e2.cache), this.queryKey = e2.queryKey, this.queryHash = e2.queryHash, c(this, Y2, Rt2(this.options)), this.state = e2.state ?? i(this, Y2), this.scheduleGc();
  }
  get meta() {
  ...
  fetch(e2, s2) {
    ...
    const r = new AbortController(), n2 = (u2) => {
      ...
      return n2(m), c(this, H2, false), this.options.persister ? this.options.persister(
        u2,
        m,
        this
      ) : u2(m);
    ...
    n2(a3), (l = this.options.behavior) == null || l.onFetch(
      a3,
      this
    ), c(this, ee2, this.state), (this.state.fetchStatus === "idle" || this.state.fetchMeta !== ((R = a3.fetchOptions) == null ? void 0 : R.meta)) && b(this, q2, j2).call(this, { type: "fetch", meta: (v = a3.fetchOptions) == null ? void 0 : v.meta });
    const h = (u2) => {
      var m, S2, w2, f2;
...
var rt = (We2 = class extends xe2 {
  constructor(e2, s2) {
    ...
    this.options = s2, c(this, O2, e2), c(this, x, null), c(this, M2, Ee2()), this.options.experimental_prefetchInRender || i(this, M2).reject(
  ...
  getOptimisticResult(e2) {
    ...
    return Ct2(this, r) && (c(this, F, r), c(this, te2, this.options), c(this, B3, i(this, d).state)), r;
  }
  getCurrentResult() {
    return i(this, F);
  }
  ...
  createResult(e2, s2) {
    ...
    if (s2.select && u2.data !== void 0)
      if (o2 && u2.data === (a3 == null ? void 0 : a3.data) && s2.select === i(this, ue2))
        ...
        try {
          c(this, ue2, s2.select), S2 = s2.select(u2.data), S2 = we(o2 == null ? void 0 : o2.data, S2, s2), c(this, se3, S2), c(this, x, null);
        } catch (E) {
          c(this, x, E);
        }
    else
    ...
    if (this.options.experimental_prefetchInRender) {
      const E = (le4) => {
        ...
        const le4 = c(this, M2, U2.promise = Ee2());
        E(le4);
      }, W3 = i(this, M2);
      switch (W3.status) {
        case "pending":
  ...
  updateResult(e2) {
    ...
    if (c(this, B3, i(this, d).state), c(this, te2, this.options), i(this, B3).data !== void 0 && c(this, re2, i(this, d)), Se(r, s2))
      return;
    c(this, F, r);
    const n2 = {}, o2 = () => {
      if (!s2)
  ...
  b(this, p, qe).call(this), c(this, L2, e2), !(V2 || I2(this.options.enabled, i(this, d)) === false || !me2(i(this, L2)) || i(this, L2) === 0) && c(this, z, setInterval(() => {
  ...
  if (e2 === i(this, d))
    return;
  const s2 = i(this, d);
  c(this, d, e2), c(this, oe, e2.state), this.hasListeners() && (s2 == null || s2.removeObserver(this), e2.addObserver(this));
}, it2 = function(e2) {
  je2.batch(() => {
...
function lm(e2) {
  return typeof e2 == "string" ? new RegExp(c2(e2), "g") : e2;
}
function cm(e2) {
...
zudoku/lib/Markdown-CWI6lU11.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-3OF3BEL3.js.map
