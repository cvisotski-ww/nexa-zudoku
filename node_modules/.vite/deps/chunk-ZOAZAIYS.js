// node_modules/zudoku/lib/router-Oe6YmY6B.js
function I() {
...
var Vr = /* @__PURE__ */ new Set(["lazy", "caseSensitive", "path", "id", "index", "children"]);
function Yr(e) {
  return e.index === true;
}
function Ne(e, t, r, a) {
  return r === void 0 && (r = []), a === void 0 && (a = {}), e.map((n, s) => {
    ...
    if (B(n.index !== true || !n.children, "Cannot specify children on an index route"), B(!a[c], 'Found a route id collision on id "' + c + `".  Route id's must be globally unique within Data Router usages`), Yr(n)) {
      let d = I({}, n, t(n), {
        id: c
      });
      return a[c] = d, d;
...
function pe(e, t, r) {
  return r === void 0 && (r = "/"), it(e, t, r, false);
}
function it(e, t, r, a) {
...
function na(e, t) {
  t === void 0 && (t = {});
  let r = e;
  r.endsWith("*") && r !== "*" && !r.endsWith("/*") && (le(false, 'Route path "' + r + '" will be treated as if it were ' + ('"' + r.replace(/\*$/, "/*") + '" because the `*` character must ') + "always follow a `/` in the pattern. To get rid of this warning, " + ('please change the route path to "' + r.replace(/\*$/, "/*") + '".')), r = r.replace(/\*$/, "/*"));
...
function ia(e, t, r) {
  t === void 0 && (t = false), r === void 0 && (r = true), le(e === "*" || !e.endsWith("*") || e.endsWith("/*"), 'Route path "' + e + '" will be treated as if it were ' + ('"' + e.replace(/\*$/, "/*") + '" because the `*` character must ') + "always follow a `/` in the pattern. To get rid of this warning, " + ('please change the route path to "' + e.replace(/\*$/, "/*") + '".'));
...
function ar(e) {
  try {
    ...
    return le(false, 'The URL path "' + e + '" could not be decoded because it is is a malformed URL segment. This is probably due to a bad percent ' + ("encoding (" + t + ").")), e;
  }
}
function Ye(e, t) {
  if (t === "/") return e;
...
var sr = (e) => e.replace(/\/+$/, "").replace(/^\/*/, "/");
var sa = (e) => !e || e === "?" ? "" : e.startsWith("?") ? e : "?" + e;
var da = (e) => !e || e === "#" ? "" : e.startsWith("#") ? e : "#" + e;
var ua = function(t, r) {
  r === void 0 && (r = {});
  ...
  onSettle(t, r, a, n) {
    ...
    if (this.pendingKeysSet.delete(r), this.done && this.unlistenAbortSignal(), a === void 0 && n === void 0) {
      ...
      return Object.defineProperty(t, "_error", {
        get: () => s
      }), this.emit(false, r), Promise.reject(s);
    }
    return n === void 0 ? (Object.defineProperty(t, "_error", {
      get: () => a
    }), this.emit(false, r), Promise.reject(a)) : (Object.defineProperty(t, "_data", {
      get: () => n
    }), this.emit(false, r), n);
  }
  emit(t, r) {
...
var ur = ["post", "put", "patch", "delete"];
var va = new Set(ur);
var wa = ["get", ...ur];
var ba = new Set(wa);
var Ra = /* @__PURE__ */ new Set([301, 302, 303, 307, 308]);
var Da = /* @__PURE__ */ new Set([307, 308]);
var ot = {
  state: "idle",
  location: void 0,
  formMethod: void 0,
...
var hr = "remix-router-transitions";
function Sa(e) {
  ...
  else if (b = false, x = [], g.v7_partialHydration) {
  ...
  }, j = $.Pop, O = false, A, G = false, V = /* @__PURE__ */ new Map(), ne = null, re = false, de = false, Je = [], Xe = /* @__PURE__ */ new Set(), Z = /* @__PURE__ */ new Map(), Ge = 0, ze = -1, Te = /* @__PURE__ */ new Map(), ue = /* @__PURE__ */ new Set(), je = /* @__PURE__ */ new Map(), Be = /* @__PURE__ */ new Map(), fe = /* @__PURE__ */ new Set(), Se = /* @__PURE__ */ new Map(), Ee = /* @__PURE__ */ new Map(), Qe;
  function Pr() {
  ...
  function Ce(i, l, u) {
    ...
    let {
      flushSync: M
    } = u === void 0 ? {} : u, C = f.actionData != null && f.navigation.formMethod != null && ae(f.navigation.formMethod) && f.navigation.state === "loading" && ((p = i.state) == null ? void 0 : p._isRedirect) !== true, E;
    ...
    let T = O === true || f.navigation.formMethod != null && ae(f.navigation.formMethod) && ((R = i.state) == null ? void 0 : R._isRedirect) !== true;
    ...
    te(I({}, l, {
      ...
      flushSync: M === true
    }), j = $.Pop, O = false, G = false, re = false, de = false, Je = [];
  }
  async function Lt(i, l) {
    ...
    let u = gt(f.location, f.matches, d, g.v7_prependBasename, i, g.v7_relativeSplatPath, l == null ? void 0 : l.fromRouteId, l == null ? void 0 : l.relative), {
      ...
      submission: R,
      error: M
    } = Kt(g.v7_normalizeFormMethod, false, u, l), C = f.location, E = ye(f.location, p, l && l.state);
    E = I({}, E, e.history.encodeLocation(E));
    let P = l && l.replace != null ? l.replace : void 0, D = $.Push;
    P === true ? D = $.Replace : P === false || R != null && ae(R.formMethod) && R.formAction === f.location.pathname + f.location.search && (D = $.Replace);
    let T = l && "preventScrollReset" in l ? l.preventScrollReset === true : void 0, _ = (l && l.flushSync) === true, N = _t({
      currentLocation: C,
      nextLocation: E,
      historyAction: D
    });
  ...
  async function Pe(i, l, u) {
    A && A.abort(), A = null, j = i, re = (u && u.startUninterruptedRevalidation) === true, Nr(f.location, f.matches), O = (u && u.preventScrollReset) === true, G = (u && u.enableViewTransition) === true;
    let p = c || o, R = u && u.overrideNavigation, M = pe(p, l, d), C = (u && u.flushSync) === true, E = et(M, p, l.pathname);
    ...
    if (u && u.pendingError)
      ...
      M = k.matches || M, D = k.pendingActionResult, R = pt(l, u.submission), C = false, E.active = false, P = _e(e.history, P.url, P.signal);
    }
    let {
      shortCircuited: T,
      matches: _,
      loaderData: N,
      errors: q
    } = await jr(P, l, M, E.active, R, u && u.submission, u && u.fetcherSubmission, u && u.replace, u && u.initialHydration === true, C, D);
    T || (A = null, Ce(l, I({
      matches: _ || M
    }, Qt(D), {
      loaderData: N,
  ...
  async function Tr(i, l, u, p, R, M) {
    ...
    if (De(E)) {
      let D;
      return M && M.replace != null ? D = M.replace : D = Yt(E.response.headers.get("Location"), new URL(i.url), d) === f.location.pathname + f.location.search, await xe(i, E, true, {
        submission: u,
        replace: D
      }), {
        shortCircuited: true
    ...
    if (ee(E)) {
      ...
      return (M && M.replace) !== true && (j = $.Push), {
        matches: p,
  ...
  async function jr(i, l, u, p, R, M, C, E, P, D, T) {
    ...
    let k = c || o, [W, J] = kt(e.history, f, u, N, l, g.v7_partialHydration && P === true, g.v7_skipActionErrorRevalidation, de, Je, Xe, fe, je, ue, k, d, T);
    ...
    let oe = nt(Ke);
    if (oe)
      return await xe(i, oe.result, true, {
        replace: E
      }), {
        shortCircuited: true
      };
    if (oe = nt(he), oe)
      return ue.add(oe.key), await xe(i, oe.result, true, {
        replace: E
      }), {
        shortCircuited: true
      };
  ...
  function Fr(i, l, u, p) {
    ...
    ve(i);
    let R = (p && p.flushSync) === true, M = c || o, C = gt(f.location, f.matches, d, g.v7_prependBasename, u, g.v7_relativeSplatPath, l, p == null ? void 0 : p.relative), E = pe(M, C, d), P = et(E, M, C);
    ...
    let {
      ...
      submission: T,
      error: _
    } = Kt(g.v7_normalizeFormMethod, true, C, p);
    if (_) {
      ce(i, l, _, {
        flushSync: R
      });
    ...
    let N = Me(E, D), q = (p && p.preventScrollReset) === true;
  ...
  async function Ur(i, l, u, p, R, M, C, E, P) {
    ...
    if (g.v7_fetcherPersist && fe.has(i)) {
      ...
      if (De(W))
        if (Z.delete(i), ze > q) {
          ...
          return ue.add(i), ge(i, Ve(P)), xe(N, W, false, {
            fetcherSubmission: P,
    ...
    let ct = Ve(P, W.data);
    f.fetchers.set(i, ct);
    let [ke, Le] = kt(e.history, f, he, P, J, false, g.v7_skipActionErrorRevalidation, de, Je, Xe, fe, je, ue, Ke, d, [p.route.id, W]);
    ...
    let X = nt(at);
    if (X)
      return xe(Fe, X.result, false, {
        preventScrollReset: E
      });
    if (X = nt(z), X)
      return ue.add(X.key), xe(Fe, X.result, false, {
        preventScrollReset: E
      });
    let {
      loaderData: Ue,
  ...
  async function Ar(i, l, u, p, R, M, C, E, P) {
    ...
    if (me(k) && (k = await Pt(k, _.signal, true) || k), Z.get(i) === T && Z.delete(i), !_.signal.aborted) {
      if (fe.has(i)) {
        ge(i, we(void 0));
        return;
      }
  ...
  async function xe(i, l, u, p) {
    ...
    l.response.headers.has("X-Remix-Revalidate") && (de = true);
    ...
    A = null;
    let T = E === true || l.response.headers.has("X-Remix-Replace") ? $.Replace : $.Push, {
      formMethod: _,
      formAction: N,
      formEncType: q
    } = f.navigation;
  ...
  function dt() {
    de = true, Je.push(...ft()), je.forEach((i, l) => {
  ...
  function Ft() {
    ...
    for (let u of ue) {
      ...
      B(p, "Expected fetcher: " + u), p.state === "loading" && (ue.delete(u), i.push(u), l = true);
    }
    return Ct(i), l;
  }
  function Ut(i) {
  ...
  function _t(i) {
    ...
    if (Ee.size === 0)
      return;
    Ee.size > 1 && le(false, "A router only supports one blocker at a time");
...
function Ea(e, t) {
  ...
  async function c(h, v) {
    ...
    let f = await m(h, b, K, w, U || null, L === true, null);
    return Re(f) ? f : I({
      location: b,
      basename: a
    }, f);
  ...
  async function d(h, v) {
    ...
    let j = await m(h, b, K, L, U || null, false, f);
    if (Re(j))
      return j;
...
function kt(e, t, r, a, n, s, o, c, d, m, y, g, S, h, v, w) {
  ...
  s && t.errors ? F = vt(r, Object.keys(t.errors)[0], true) : w && ee(w[1]) && (F = vt(r, w[0]));
  let b = w ? w[1].statusCode : void 0, K = o && b && b >= 400, f = F.filter((O, A) => {
    ...
    return $t(O, I({
      ...
      actionResult: L,
      actionStatus: b,
      defaultShouldRevalidate: K ? false : (
  ...
  return g.forEach((O, A) => {
    ...
    let V = t.fetchers.get(A), ne = Me(G, O.path), re = false;
    S.has(A) ? re = false : m.has(A) ? (m.delete(A), re = true) : V && V.state !== "idle" && V.data === void 0 ? re = c : re = $t(ne, I({
      currentUrl: U,
      ...
      actionResult: L,
      actionStatus: b,
      defaultShouldRevalidate: K ? false : c
    })), re && j.push({
      key: A,
      routeId: O.routeId,
      path: O.path,
...
async function vr(e, t, r, a, n, s, o, c, d, m) {
  let y = s.map((h) => h.route.lazy ? Ma(h.route, d, c) : void 0), g = s.map((h, v) => {
    ...
    return I({}, h, {
      shouldLoad: L,
      resolve: async (x) => (x && a.method === "GET" && (h.route.lazy || h.route.loader) && (L = true), L ? Ta(t, a, h, w, x, m) : Promise.resolve({
        type: H.data,
        result: void 0
      }))
    });
...
function br(e, t, r, a, n, s) {
  ...
  if (B(o, "Redirects returned/thrown from loaders/actions must have a Location header"), !Et.test(o)) {
    ...
    o = gt(new URL(t.url), c, n, true, o, s), e.headers.set("Location", o);
  }
  return e;
}
function Yt(e, t, r) {
...
function Rr(e, t, r, a, n) {
  let s = {}, o = null, c, d = false, m = {}, y = r && ee(r[1]) ? r[1].error : void 0;
  return e.forEach((g) => {
    if (!(g.route.id in t))
      return;
    ...
    if (B(!De(h), "Cannot handle redirect results in processLoaderData"), ee(h)) {
      ...
      s[S] = void 0, d || (d = true, c = He(h.error) ? h.error.status : 500), h.headers && (m[S] = h.headers);
    } else
  ...
  return n.forEach((m) => {
    ...
    if (B(h, "Did not find corresponding fetcher result"), !(S && S.signal.aborted))
      if (ee(h)) {
        ...
        B(false, "Unhandled fetcher revalidation redirect");
      else if (me(h))
        B(false, "Unhandled fetcher deferred data");
      else {
        let v = we(h.data);
        e.fetchers.set(y, v);
      }
...
async function Ua(e, t, r, a, n) {
  ...
  for (let o = 0; o < s.length; o++) {
    ...
    me(d) && g && await Pt(d, r, false).then((S) => {
      S && (t[c] = S);
    });
  }
}
async function Aa(e, t, r) {
  for (let a = 0; a < r.length; a++) {
    ...
    e.find((m) => (m == null ? void 0 : m.route.id) === s) && me(c) && (B(o, "Expected an AbortController for revalidating fetcher deferred result"), await Pt(c, o.signal, true).then((m) => {
      m && (t[n] = m);
    }));
  }
}
...
function Na(e, t) {
  if (t.size > 0) {
    ...
    try {
      ...
      le(false, "Failed to save applied view transitions in sessionStorage (" + a + ").");
    }
  }
}
var Ha = Object.freeze(Object.defineProperty({
  __proto__: null,
...
zudoku/lib/router-Oe6YmY6B.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-ZOAZAIYS.js.map
