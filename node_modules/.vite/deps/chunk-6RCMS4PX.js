...
// node_modules/zudoku/lib/jsx-runtime-B6kdoens.js
...
function cr() {
  return Se || (Se = 1, function() {
    ...
    var xe = false, ke = false, De = false, Fe = false, Ae = false, ee;
...
` + a[s].replace(" at new ", " at ");
        ...
        J = false, N.current = u, $e(), Error.prepareStackTrace = i;
      }
    ...
    function Ue(e, r, t, n, i) {
      {
        ...
        for (var o in e)
          if (u(e, o)) {
            ...
            a && !(a instanceof Error) && (V(i), l("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", n || "React class", t, o, typeof a), V(null)), a instanceof Error && !(a.message in ce) && (ce[a.message] = true, V(i), l("Failed %s type: %s", t, a.message), V(null));
          }
      }
    }
    ...
    function ze(e, r) {
      if (typeof e.ref == "string" && k.current && r && k.current.stateNode !== r) {
        ...
        q[t] || (l('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', y(k.current.type), e.ref), q[t] = true);
      }
    }
    function Xe(e, r) {
      {
        var t = function() {
          ge || (ge = true, l("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", r));
        };
    ...
    function He(e, r) {
      {
        var t = function() {
          ye || (ye = true, l("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", r));
        };
...
React keys must be passed directly to JSX without using spread:
  let props = %s;
  <%s key={someKey} {...props} />`, H, R, sr, R), me[R + H] = true;
          }
        }
    ...
    function ar(e, r, t) {
      return Te(e, r, t, true);
    }
    function or(e, r, t) {
      return Te(e, r, t, false);
    }
    var ir = or, ur = ar;
    F.Fragment = m, F.jsx = ir, F.jsxs = ur;
  }()), F;
}
false ? Z.exports = lr() : Z.exports = cr();
var dr = Z.exports;
...
zudoku/lib/jsx-runtime-B6kdoens.js:
  (**
   * @license React
...
zudoku/lib/jsx-runtime-B6kdoens.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-6RCMS4PX.js.map
